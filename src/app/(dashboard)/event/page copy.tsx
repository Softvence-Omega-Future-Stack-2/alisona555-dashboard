...
const initialEvents = [
  ...
  {
    id: "E-006",
    eventName: "Skydiving over Palm Jumeirah",
    location: "Dubai",
    category: "Adventure",
    date: "Aug 15, 2026",
    booked: 12,
  ...
  {
    id: "E-007",
    eventName: "Hot Air Balloon Ride",
    location: "Dubai",
    category: "Adventure",
    date: "Sep 10, 2026",
    booked: 18,
    ...
    <div>
      ...
      <div className="bg-white py-4 p-6 md:p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Dialog>
          ...
          <DialogContent className="scrollbar-thin sm:max-w-175 w-[95vw] max-h-[92vh] overflow-y-auto p-0 border-none rounded-2xl bg-white focus:outline-none focus-visible:ring-0">
            ...
            <div className="p-4 sm:p-6">
              <form className="space-y-5">
                ...
                <div className="space-y-1.5">
                  <label className="text-[13px] font-semibold text-[#4B5563] mb-2">
                    Event Title
                  </label>
                  <Input
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    className="flex min-h-20 w-full rounded-lg border border-gray-200 bg-white px-3 py-3 text-[14px] ring-offset-white placeholder:text-gray-400 disabled:cursor-not-allowed disabled:opacity-50"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <select
                        defaultValue=""
                        className="h-11 w-full border border-gray-200 rounded-lg px-3 text-[14px] bg-white appearance-none focus:outline-none focus:border-gray-300 pr-10"
                      >
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        className="h-11 border-gray-200 rounded-lg text-[14px] pr-10"
                      />
                      <CalendarIcon className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 w-4.5 h-4.5" />
                    </div>
                  </div>
                  <div className="space-y-1.5">
                    <label className="text-[13px] font-semibold text-[#4B5563]">
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    placeholder="Enter event description"
                    className="flex min-h-[100px] w-full rounded-lg border border-gray-200 bg-white px-3 py-3 text-[14px] ring-offset-white placeholder:text-gray-400"
                  />
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    placeholder="Enter event description"
                    className="flex min-h-[80px] w-full rounded-lg border border-gray-200 bg-white px-3 py-3 text-[14px] ring-offset-white placeholder:text-gray-400"
                  />
                </div>
                ...
                <div className="space-y-4 pt-2 border-t border-gray-100">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <Input
                        defaultValue="Full refund if cancelled 48 hours before event"
                        className="h-11 border-gray-200 rounded-lg text-[14px]"
                      />
                    </div>
                  </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4">
                  <DialogClose asChild>
                    <Button
                      type="button"
                      variant="outline"
                      className="flex-1 order-2 md:order-1 h-12 rounded-xl border-gray-200 text-black cursor-pointer font-semibold hover:bg-gray-50 text-[15px]"
                    >
                      Cancel
                    </Button>
                  </DialogClose>
                  <Button
                    type="button"
                    className="flex-1 order-1 md:order-2 h-12 rounded-xl bg-brand-gold hover:bg-brand-gold-hover text-white font-bold text-[15px] cursor-pointer"
                  >
                    Create Event
                  </Button>
                </div>
      ...
      <div className="bg-[#F8FAFC] rounded-2xl overflow-hidden border border-gray-100 px-6 md:px-8">
        ...
        <div className="bg-white py-4 px-6 flex items-center justify-center gap-2 border-t border-gray-50">
          ...
          <button className="w-8 h-8 flex items-center justify-center rounded-lg text-sm text-gray-600 hover:bg-gray-100 font-medium">
            1
          </button>
          <button className="w-8 h-8 flex items-center justify-center rounded-lg text-sm bg-blue-50 text-brand-purple font-medium">
            2
          </button>
          <button className="w-8 h-8 flex items-center justify-center rounded-lg text-sm text-gray-600 hover:bg-gray-100 font-medium">
            3
