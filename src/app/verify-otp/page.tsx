    ...
    return (
        <div className="min-h-screen bg-[#0B1120] flex items-center justify-center relative overflow-hidden">
            ...
            <div className="z-10 w-full max-w-md px-6 flex flex-col items-center">
                ...
                <p className="text-white/70 text-sm mb-8 text-center">We have sent you a 6 digit OTP code to your provided email: example@email.com please input that code here to proceed.</p>
